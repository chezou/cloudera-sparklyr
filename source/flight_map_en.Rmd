---
title: "Analyzing US flight map with sparlyr"
author: "Aki Ariga"
date: "1/19/2017"
...
In this document, we will show you visualization and buliding predictive model of US flights with sparklyr.
Flight visualization code is based on this article:
...
This document assume you have tables of:

- [Airlines data](https://ibis-resources.s3.amazonaws.com/data/airlines/airlines_parquet.tar.gz) as `airlines_bi_pq`. It is assumed put on S3, but you can put into HDFS. See also [Ibis project](http://www.ibis-project.org/pages/data.html#airlines).
- [Airports data](http://stat-computing.org/dataexpo/2009/airports.csv) converted into parquet format as `airports_new_pq`. See also [2009 ASA Data Expo](http://stat-computing.org/dataexpo/2009/supplemental-data.html).
...
Let's connect with your Spark cluster with sparklyr.
...
sparklyr's table is evaluated lazy, so you should use `collect` to convert into data.frame.
...
It is came out that the flight number after Sept. 2001 significantly decreased. We can understand it is the effect of 9/11.
