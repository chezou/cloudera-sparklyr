...
- [Airports data](http://stat-computing.org/dataexpo/2009/airports.csv) を`airports_new_pq`という名前のテーブルにparquet形式で保存しています。 こちらもご覧ください [2009 ASA Data Expo](http://stat-computing.org/dataexpo/2009/supplemental-data.html).
